...
我们可以通过浏览器访问某些 HTTPS 域名，使用抓包工具（wireshark），抓包分析 TLS 的工作流程。
...
<div align=center><img src="/images/2023/2023-10-09-20-36-05.png" data-action="zoom"></div>
...
证书来源渠道很多，普通证书可以通过 openssl 生成，而由权威的证书颁发机构 CA（Certificate Authority）签发的数字证书须要通过相关平台付费购买或者免费申请。
