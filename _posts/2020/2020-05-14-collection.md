...
| redis | [redis-stat](https://github.com/junegunn/redis-stat) <br> [认识 MySQL 和 Redis 的数据一致性问题](https://cloud.tencent.com/developer/article/1898550) <br/>[Redis如何绑定CPU](https://blog.csdn.net/wejack/article/details/126284878)|
