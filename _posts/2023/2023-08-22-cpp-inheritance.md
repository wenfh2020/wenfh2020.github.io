...
* 关于有继承关系的 C++ 多态探索，因为本人水平有限，以上只作了一些基础简单的 Demo 的分析，可能还有一些应用场景没有涉及。

* 很多技术细节没有在文章中提及，有兴趣的朋友可以动手写写 demo 用 gdb 调试一下，查看对象内存布局上的地址数据，以及反汇编查看对象构造的逻辑，是否与自己的理解一致，这样才能在不断变化的的问题表象里，找到答案的本质。
