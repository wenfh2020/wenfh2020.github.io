...
3. 阿里云域名重定向，将购买的域名重定向到你的 xxx.github.io 域名。
4. 在你的 xxx.github.io 目录下添加 `CNAME` 文件，写入你的域名 `xxx.com`，提交文件到 github。
5. 域名要升级为 https，参考 [http 升级 https](https://blog.csdn.net/b_aihe/article/details/88549757)。
